...
class _RequestDetail extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final status = r['status'] ?? 'pending';
    final cfg =
        _reqStatuses[status] ?? {'label': status, 'color': AppTheme.textMuted};
    final color = cfg['color'] as Color;
    ...
    return Padding(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Row(children: [
          Expanded(
              child: Text(_reqTypes[r['type']] ?? r['type'] ?? '—',
                  style: const TextStyle(
        ...
        Expanded(
            child: SingleChildScrollView(
              ...
              InfoRow(
                  ...
                  label: 'Contrat',
                  value:
                      r['contract']?['type']?.toString().toUpperCase() ?? '—'),
              ...
              if (r['proposed_contract_type'] != null)
                InfoRow(
                    ...
                    label: 'Type proposé',
                    value:
                        r['proposed_contract_type'].toString().toUpperCase()),
              if (r['reason'] != null) ...[
